...
from turtleapi.models.turtlemodels import (TridentEncounter, Encounter, Turtle, Tag,
                                           ...
                                           MetadataSchema, TridentEncounterSchema, SampleSchema,
...
def insert_trident(data):
    ...
    trident_encounter = TridentEncounter(
        ...
        capture_location = encounter['capture_location'],
        capture_method = encounter['capture_method'],
        number_on_carapace = encounter['number_on_carapace'],
        ...
        disposition_of_specimen=encounter['disposition_of_specimen'],
