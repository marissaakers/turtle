...
Revision ID: 394a51bb4a5f
Revises: 3243c092326f
Create Date: 2020-01-10 19:50:43.654337
...
revision = '394a51bb4a5f'
down_revision = '3243c092326f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['beach_encounter_id'], ['beachencounter.beach_encounter_id'], ),
    ...
    op.add_column('clutch', sa.Column('turtle_id', sa.Integer(), nullable=False))
    op.create_foreign_key(None, 'clutch', 'turtle', ['turtle_id'], ['turtle_id'])
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'clutch', type_='foreignkey')
