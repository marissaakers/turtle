...
Revision ID: cc3e48ca4bde
Revises: 394a51bb4a5f
Create Date: 2020-01-10 20:06:09.563782
...
revision = 'cc3e48ca4bde'
down_revision = '394a51bb4a5f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.UniqueConstraint('hatchlings_id')
    )
